...
async def send_document(update: Update, context: ContextTypes.DEFAULT_TYPE, file_path: pathlib.Path, user_filename: str,
...
async def send_video(update: Update, context: ContextTypes.DEFAULT_TYPE, file_path: pathlib.Path, user_filename: str,
                     log_intent: str, caption: str = None):
